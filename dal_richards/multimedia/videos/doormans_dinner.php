...
<div class="textBoxOne">
	<div class="largeTextTitle">Annual Doorman's Dinner</div>
    <div class="smallTextTitle">A Man and His Music - A Tribute to Dal Richards</div>
    <br />
    <div align="center">
    <script language="JavaScript" type="text/javascript">insertQTMovie("/DalTV/Dal_Richards_Annual_Doormans_Dinner.mov");</script>
    </div>
    <p>&nbsp;</p>
    <p>&nbsp;</p>

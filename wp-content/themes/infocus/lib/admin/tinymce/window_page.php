...
<!-- <form onsubmit="insertLink();return false;" action="#"> -->
	...
	<div class="tabs">
		<ul>
			<li id="portfolio_tab" class="current"><span><a href="javascript:mcTabs.displayTab('portfolio_tab','portfolio_panel');" onmousedown="return false;"><?php echo 'Portfolio'; ?></a></span></li>
	...
	<div class="panel_wrapper" style="height:142px;">
		<!-- portfolio_panel -->
		<div id="portfolio_panel" class="panel current">
		<br />
		<fieldset>

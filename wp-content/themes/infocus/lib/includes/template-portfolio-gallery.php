...
<div id="body_block">
	...
	<?php if($portfolio_full) { $counter++; $counter_last++; ?>
		<div class="one_third<?php if($counter_last == 3) { echo " last"; $counter_last = 0; } ?>">
			...
			<span><a class="button_link" target="_blank" href="<?php echo $portfolio_link; ?>"><span>Visit Site</span></a></span>
			<?php } ?>

...
if ( function_exists( 'add_shortcode_param' ) ) {
	...
	function grve_icon_settings_field( $param, $param_value ) {
	...
	add_shortcode_param( 'grve_icon', 'grve_icon_settings_field', GRVE_OSMOSIS_VC_EXT_PLUGIN_DIR_URL . '/assets/js/grve-icon-preview.js' );
	
	function grve_multi_checkbox_settings_field( $param, $param_value ) {
		$dependency = vc_generate_dependencies_attributes( $param );
	...
	add_shortcode_param( 'grve_multi_checkbox', 'grve_multi_checkbox_settings_field', GRVE_OSMOSIS_VC_EXT_PLUGIN_DIR_URL . '/assets/js/grve-multi-checkbox.js' );	

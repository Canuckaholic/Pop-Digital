...
read this article for this [performance plugin](http://www.satya-weblog.com/2010/08/website-performance-optimization-plugin-ordering-stylesheet-javascript.html). 
...
For more details discussion, you can follow the [author](http://www.satya-weblog.com/about/ "Satya Prakash") on [Facebook](http://www.facebook.com/pages/Web-Scripting/176350059435).



Another WP plugin from [Satya](http://www.satya-weblog.com/) - [Escape HTML](http://wordpress.org/extend/plugins/escape-html/).
...
4. Please, **add the following lines of PHP code at header.php file where you see &lt;head&gt; section**.

You need to add only PHP lines given below. HTML code is for demonstration purpose only. 

Mime type "UTF-8" is my blog's mime type. Mention your blog's mime type in meta tag. If "Content-Type" is not available (suppose) in your Wordpress header.php file, 
...
= Where it add itself in Admin panel? = 

It add itself in Settings section. There also you will get installation guidelines. 

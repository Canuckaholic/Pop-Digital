...
function wpns_reg_function() {
	...
	register_setting( 'wpns-settings-group', 'wpns_speed' );
	register_setting( 'wpns-settings-group', 'wpns_pause' );
}
...
function wpns_activate() {
	...
	add_option('wpns_speed','500');
	add_option('wpns_pause','3000');
}
...
.nivo-controlNav {
	...
	left:35%;
	position:absolute;
	/*background:url("<?php echo WP_PLUGIN_URL . "/wp-nivo-slider/"; ?>images/bullet_ribbon.png") no-repeat scroll 0 0 transparent;*/
	padding: 8px 62px;
	height: 24px;
	width: 133px;
	z-index: 100;
...
.nivo-controlNav a {
	background:url("<?php echo WP_PLUGIN_URL . "/wp-nivo-slider/"; ?>images/bullets2.png") no-repeat scroll 0 0 transparent;
	border:0 none;
	display:block;
	float:left;
	height:12px;
...
jQuery(window).load(function() {
	jQuery('#slider').nivoSlider({
		...
		animSpeed:<?php echo get_option('wpns_speed'); ?>, //Slide transition speed
        pauseTime:<?php echo get_option('wpns_pause'); ?>,
...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <td>
        <label>
        <input type="text" name="wpns_speed" id="wpns_speed" size="7" value="<?php echo get_option('wpns_speed'); ?>" />
        </label>
        </tr>
        
        <tr valign="top">
        <th scope="row">Pause Length</th>
        <td>
        <label>
        <input type="text" name="wpns_pause" id="wpns_pause" size="7" value="<?php echo get_option('wpns_pause'); ?>" />
        </label>
        </tr>

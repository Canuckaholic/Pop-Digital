...
<html>
<head>
<title>Tactical Actions Group Inc.</title>
...
<body>
<?php include($DOCUMENT_ROOT . "/common/header.php"); ?>
<div id="middle">
	<div id="homepageMiddle">
		Homepage Middle Flash
	</div>
	<script type="text/javascript">
		var f1 = new FlashObject("/flash/TAG_middle_homepage.swf", "homepage_flash", "733", "334", "6.0.29", "#FFFFFF");
		f1.addParam("quality", "high");
		f1.addParam("wmode", "transparent");		
   		f1.write("homepageMiddle");
	</script>
</div>
